...
def unpickler(zone, utcoffset=None, dstoffset=None, tzname=None):
    ...
    model changes could cause a zones implementation to switch between
    ...
    try:
        ...
        # This indicates a corrupt pickle, or the timezone model has been
    ...
    # get changed from the initial guess by the model maintainers to
    ...
    # zone. Add it back. This might occur when the model maintainers have
