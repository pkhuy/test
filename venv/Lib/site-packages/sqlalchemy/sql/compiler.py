...
class Compiled(object):
    ...
    specific to their underlying model dialect, and also may
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def visit_insert(self, insert_stmt, **kw):
        ...
        if (
            ...
            raise exc.CompileError(
                "The '%s' dialect with current model "
...
class IdentifierPreparer(object):
    ...
    def _escape_identifier(self, value):
        ...
        Subclasses should override this to provide model-dependent
        escaping behavior.
        """
    ...
    def quote_schema(self, schema, force=None):
        ...
        Subclasses can override this to provide model-dependent
    ...
    def format_table_seq(self, table, use_schema=True):
        ...
        # ('model', 'owner', etc.) could override this and return
        # a longer sequence.
