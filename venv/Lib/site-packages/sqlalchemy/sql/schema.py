...
"""The schema module provides the building blocks for model metadata.

Each element within this module describes a model entity which can be
...
schema elements, and can also be associated with an actual model connection
such that operations involving the contained elements can contact the model
as needed.
...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    """Base class for items that define a model schema."""
...
class Table(DialectKWArgs, SchemaItem, TableClause):
    r"""Represent a table in a model.
    ...
    .. seealso::
        ...
        :ref:`metadata_describing` - Introduction to model metadata

    Constructor arguments are as follows:

    :param name: The name of this table as represented in the model.
    ...
    :param autoload: Defaults to ``False``, unless
        ...
        for this table should be reflected from the model, possibly
    ...
    :param extend_existing: When ``True``, indicates that if this
        ...
        operation against the model, even if a :class:`_schema.Table`
        ...
        objects
        both reflected from the model, as well as the given
    ...
    :param schema: The schema name for this table, which is required if
        ...
        for the engine's model connection.  Defaults to ``None``.
    ...
    def _init(self, name, metadata, *args, **kwargs):
        ...
        # load column definitions from the model if 'autoload' is defined
    ...
    def append_column(self, column, replace_existing=False):
        ...
        as it exists within any underlying model, assuming that
        table has already been created in the model.   Relational
    ...
    def append_constraint(self, constraint):
        ...
        relational model automatically, for a table that already exists
        in the model.   To add a constraint to an
        existing relational model table, the SQL ALTER command must
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    """Represents a column in a model table."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param name: The name of this column as represented in the model.
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          .. versionchanged:: 1.1 The autoincrement flag now defaults to
             ...
             subject to limitations of the backend model and dialect.
          ...
          * DDL issued for the column will include model-specific
          ...
          * The column will be considered to be available using an
            "autoincrement" method specific to the backend model, such
        ...
        :param default: A scalar, Python callable, or
            ...
            *default value* for this column, which will be invoked upon insert
            ...
            which creates a default generator on the model side.
        ...
        :param nullable: When set to ``False``, will cause the "NOT NULL"
            ...
            .. note::
                ...
                PostgreSQL model allows nullable identity column by
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            column will generate a default value on the model side which
            will be available to SQLAlchemy for post-fetch after inserts. This
            construct does not specify any DDL and the implementation is left
            to the model, such as via a trigger.
        ...
        :param server_onupdate: A :class:`.FetchedValue` instance
            representing a model-side default generation function,
            such as a trigger. This
            indicates to SQLAlchemy that a newly generated value will be
            available after updates. This construct does not actually
            implement any kind of generation function within the model,
        ...
        :param unique: When ``True``, and the :paramref:`_schema.Column.index`
            ...
            a model-specific naming convention to take place.
        ...
        :param system: When ``True``, indicates this is a "system" column,
             ...
             model, and should not be included in the columns list for a
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name: Optional string. An in-model name for the key if
    ...
    def _column_tokens(self):
        ...
        # inter-model foreign keys. See tickets#1341 and --
...
class IdentityOptions(object):
    """Defines options for a named model sequence or an identity column.
...
class Sequence(IdentityOptions, DefaultGenerator):
    ...
    def __init__(
        ...
        :param start: the starting index of the sequence.  This value is
         used when the CREATE SEQUENCE command is emitted to the model
         as the value of the "START WITH" clause.   If ``None``, the
         clause is omitted, which on most platforms indicates a starting
         value of 1.
        :param increment: the increment value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the model as the value of the "INCREMENT BY" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates an
         increment of 1.
        :param minvalue: the minimum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the model as the value of the "MINVALUE" clause.  If ``None``,
        ...
        :param maxvalue: the maximum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the model as the value of the "MAXVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
        ...
        :param nominvalue: no minimum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the model as the value of the "NO MINVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
         minvalue of 1 and -2^63-1 for ascending and descending sequences,
         respectively.
        ...
        :param nomaxvalue: no maximum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the model as the value of the "NO MAXVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
         maxvalue of 2^63-1 and -1 for ascending and descending sequences,
         respectively.
        ...
        :param cycle: allows the sequence to wrap around when the maxvalue
         ...
         is emitted to the model as the "CYCLE" clause.  If the limit is
    ...
    def create(self, bind=None, checkfirst=True):
        """Creates this sequence in the model.
    ...
    def drop(self, bind=None, checkfirst=True):
        """Drops this sequence from the model.
...
class FetchedValue(SchemaEventTarget):
    """A marker for a transparent model-side default.

    Use :class:`.FetchedValue` when the model is configured
...
class Constraint(DialectKWArgs, SchemaItem):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name:
          Optional, the in-model name of this ``Constraint``.
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    def __init__(
        ...
        **kw
        ...
        :param name:
          Optional, the in-model name of the constraint.
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name: Optional, the in-model name of the key.
...
class MetaData(SchemaItem):
    ...
    def reflect(
        ...
        **dialect_kwargs
        ...
        r"""Load all available table definitions from the model.

        Automatically creates ``Table`` entries in this ``MetaData`` for any
        table available in the model but not yet present in the
        ``MetaData``.  May be called multiple times to pick up tables recently
        added to the model, however no special action is taken if a table
        in this ``MetaData`` no longer exists in the model.

        :param bind:
          A :class:`.Connectable` used to access the model; if None, uses
    ...
    def create_all(self, bind=None, tables=None, checkfirst=True):
        ...
        :param bind:
          ...
          model; if None, uses the existing bind on this ``MetaData``, if
          any.
    ...
    def __init__(self, sqltext, persisted=None):
        ...
        :param persisted:
          ...
          * ``True``, will render ``GENERATED ALWAYS AS ... STORED``, or the
            equivalent for the target model if supported.
          * ``False``, will render ``GENERATED ALWAYS AS ... VIRTUAL``, or
            the equivalent for the target model if supported.

          Specifying ``True`` or ``False`` may raise an error when the DDL
          is emitted to the target model if the model does not support
