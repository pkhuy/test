...
class HasHints(object):
    ...
    def with_statement_hint(self, text, dialect_name="*"):
        ...
        Hints here are specific to the backend model and may include
        ...
        .. seealso::
            ...
            which also can suit some model-specific HINT syntaxes such as
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def with_for_update(
        ...
        On a model like PostgreSQL or Oracle, the above would render a
        statement like::
        ...
        provided which allow for common model-specific
        variants.
