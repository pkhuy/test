...
"""Global model feature support policy.
...
class SuiteRequirements(Requirements):
    ...
    def foreign_keys(self):
        """Target model must support foreign keys."""
    ...
    def standard_cursor_sql(self):
        """Target model passes SQL-92 style statements to cursor.execute()
    ...
    def on_update_cascade(self):
        """target model must support ON UPDATE..CASCADE behavior in
        foreign keys."""
    ...
    def non_updating_cascade(self):
        """target model must *not* support ON UPDATE..CASCADE behavior in
        foreign keys."""
        return exclusions.closed()
    ...
    @property
    def queue_pool(self):
        """target model is using QueuePool"""
    ...
    def self_referential_foreign_keys(self):
        """Target model must support self-referential foreign keys."""

        return exclusions.open()

    @property
    def foreign_key_ddl(self):
        """Target model must support the DDL phrases for FOREIGN KEY."""

        return exclusions.open()

    @property
    def named_constraints(self):
        """target model must support names for constraints."""

        return exclusions.open()

    @property
    def implicitly_named_constraints(self):
        """target model must apply names to unnamed constraints."""

        return exclusions.open()

    @property
    def subqueries(self):
        """Target model must support subqueries."""

        return exclusions.open()

    @property
    def offset(self):
        """target model can render OFFSET, or an equivalent, in a
        SELECT.
        """
    ...
    def bound_limit_offset(self):
        """target model can render LIMIT and/or OFFSET using a bound
        parameter
        """
    ...
    def sql_expression_limit_offset(self):
        """target model can render LIMIT and/or OFFSET with a complete
    ...
    def parens_in_union_contained_select_w_limit_offset(self):
        """Target model must support parenthesized SELECT in UNION
    ...
    def boolean_col_expressions(self):
        """Target model must support boolean expressions as columns"""

        return exclusions.closed()

    @property
    def nullable_booleans(self):
        """Target model allows boolean columns to store NULL."""
    ...
    def standalone_binds(self):
        """target model/driver supports bound parameters as column expressions
    ...
    def standalone_null_binds_whereclause(self):
        """target model/driver supports bound parameters with NULL in the
    ...
    @property
    def intersect(self):
        """Target model must support INTERSECT or equivalent."""
        return exclusions.closed()

    @property
    def except_(self):
        """Target model must support EXCEPT or equivalent (i.e. MINUS)."""
        return exclusions.closed()

    @property
    def window_functions(self):
        """Target model must support window functions."""
        return exclusions.closed()

    @property
    def ctes(self):
        """Target model supports CTEs"""

        return exclusions.closed()

    @property
    def ctes_with_update_delete(self):
        """target model supports CTES that ride on top of a normal UPDATE
    ...
    def ctes_on_dml(self):
        """target model supports CTES which consist of INSERT, UPDATE
    ...
    def full_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(model)s %(does_support)s 'RETURNING of multiple rows'",
        )
    ...
    def insert_executemany_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(model)s %(does_support)s 'RETURNING of "
    ...
    def returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(model)s %(does_support)s 'RETURNING of a single row'",
        )
    ...
    def denormalized_names(self):
        """Target model must have 'denormalized', i.e.
    ...
    def multivalues_inserts(self):
        """target model must support multiple VALUES clauses in an
        INSERT statement."""
    ...
    def emulated_lastrowid(self):
        ...
        from a model-side function after an insert() construct executes,
    ...
    @property
    def views(self):
        """Target model must support VIEWs."""

        return exclusions.closed()

    @property
    def schemas(self):
        """Target model must support external schemas, and have one
        named 'test_schema'."""
    ...
    @property
    def sequences(self):
        """Target model must support SEQUENCEs."""
    ...
    def sequences_optional(self):
        """Target model supports sequences, but also optionally
    ...
    def supports_lastrowid(self):
        """target model / driver supports cursor.lastrowid as a means
    ...
    def view_column_reflection(self):
        """target model must support retrieval of the columns in a view,
    ...
    def view_reflection(self):
        """target model must support inspection of the full CREATE VIEW
        definition."""
        return self.views
    ...
    def temporary_tables(self):
        """target model supports temporary tables"""
        return exclusions.open()

    @property
    def temporary_views(self):
        """target model supports temporary views"""
        return exclusions.closed()
    ...
    def indexes_with_ascdesc(self):
        """target model supports CREATE INDEX with per-column ASC/DESC."""
        return exclusions.open()

    @property
    def indexes_with_expressions(self):
        """target model supports CREATE INDEX against SQL expressions."""
        return exclusions.closed()
    ...
    def unbounded_varchar(self):
        """Target model must support VARCHAR with no length"""

        return exclusions.open()

    @property
    def unicode_data(self):
        """Target model/dialect must support Python unicode objects with
    ...
    def binary_comparisons(self):
        """target model/driver can allow BLOB/BINARY fields to be compared
    ...
    def nested_aggregates(self):
        """target model can select an aggregate from a subquery that's
    ...
    def recursive_fk_cascade(self):
        """target model must support ON DELETE CASCADE on a self-referential
        foreign key
    ...
    @property
    def text_type(self):
        """Target model must support an unbounded Text() "
    ...
    def empty_strings_varchar(self):
        """target model can persist/return an empty string with a
        varchar.
    ...
    def empty_strings_text(self):
        """target model can persist/return an empty string with an
        unbounded text."""
    ...
    def expressions_against_unbounded_text(self):
        """target model supports use of an unbounded textual field in a
        WHERE clause."""
    ...
    @property
    def savepoints(self):
        """Target model must support savepoints."""

        return exclusions.closed()

    @property
    def two_phase_transactions(self):
        """Target model must support two-phase transactions."""
    ...
    def mod_operator_as_percent_sign(self):
        """target model must use a plain percent '%' as the 'modulus'
        operator."""
        return exclusions.closed()
    ...
    def order_by_col_from_union(self):
        """target model supports ordering by a column from a SELECT
        inside of a UNION
    ...
    def independent_connections(self):
        """
        Target must support simultaneous, independent model connections.
        """
        return exclusions.open()
