...
def setup_options(make_option):
    ...
    make_option(
        ...
        type=str,
        dest="db",
        help="Use prefab model uri. Multiple OK, "
    ...
    make_option(
        ...
        type="string",
        dest="dbdriver",
        help="Additional model drivers to include in tests.  "
        "These are linked to the existing model URLs by the "
        "provisioning system.",
    )
    make_option(
        "--dropfirst",
        action="store_true",
        dest="dropfirst",
        help="Drop all tables in the target model first",
    )
    make_option(
        "--disable-asyncio",
        action="store_true",
    ...
    make_option(
        ...
        type=str,
        help="name of template model to use for PostgreSQL "
        "CREATE DATABASE (defaults to current model)",
    )
    make_option(
        "--low-connections",
        action="store_true",
...
def _engine_uri(options, file_config):
    ...
    for db_url in expanded_urls:
        log.info("Adding model URL: %s", db_url)
