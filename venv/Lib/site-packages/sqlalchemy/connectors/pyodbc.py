...
class PyODBCConnector(Connector):
    ...
    def create_connect_args(self, url):
        ...
        if "odbc_connect" in keys:
            ...
            dsn_connection = "dsn" in keys or (
                "host" in keys and "model" not in keys
            )
            if dsn_connection:
                connectors = [
            ...
            # convert textual data from your model encoding to your
            # client encoding.  This should obviously be set to 'No' if
            # you query a cp1253 encoded model from a latin1 client...
    ...
    def _get_server_version_info(self, connection, allow_chars=True):
        ...
        # freetds is in use.   Implement model-specific server version
        # queries.
