...
class ConnectionEvents(event.Events):
    ...
    to the model.  The :meth:`.before_cursor_execute` event is
    ...
    def before_execute(
        ...
        as early manipulation of the parameters being sent to the model,
    ...
    def engine_connect(self, conn, branch):
        ...
        refers to the actual connection to a model at the DBAPI level;
