...
class FullyBufferedCursorFetchStrategy(CursorFetchStrategy):
    ...
    after the model conversation can not be continued,
...
class BaseCursorResult(object):
    """Base class for model result objects."""
    ...
    def _init_metadata(self, context, cursor_description):
        ...
        if context.compiled:
            ...
            # be using the cached Column objects against this model result
    ...
    def inserted_primary_key(self):
        ...
        :class:`_schema.Column`), and were generated using the model-side
...
class CursorResult(BaseCursorResult, Result):
    ...
    Returns model rows via the :class:`.Row` class, which provides
