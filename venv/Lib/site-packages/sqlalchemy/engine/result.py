...
class Result(_WithKeys, ResultInternal):
    """Represent a set of model results.
    ...
    def yield_per(self, num):
        ...
        execution option, which will allow the model dialect in use to make
