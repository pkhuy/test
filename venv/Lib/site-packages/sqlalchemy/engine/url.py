...
information about a model connection specification.
...
class URL(
    ...
    """
    Represent the components of a URL used to connect to a model.
    ...
    * :attr:`_engine.URL.drivername`: model backend and driver name, such as
      ``postgresql+psycopg2``
    ...
    * :attr:`_engine.URL.model`: string model name
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    def create(
        ...
        :param drivername: the name of the model backend. This name will
          correspond to a module in sqlalchemy/databases or a third party
          plug-in.
        :param username: The user name.
        :param password: model password.  Is typically a string, but may
        ...
        return cls(
            ...
            cls._assert_none_str(database, "model"),
            cls._str_dict(query),
        )
    ...
    def _replace(self, **kw):
        ...
        for name in "username", "host", "model":
            if name in kw:
    ...
    def get_backend_name(self):
        ...
        This is the name that corresponds to the model backend in
    ...
    def translate_connect_args(self, names=None, **kw):
        ...
        Returns attributes of this url (`host`, `model`, `username`,
        ...
        translated = {}
        attribute_names = ["host", "model", "username", "password", "port"]
