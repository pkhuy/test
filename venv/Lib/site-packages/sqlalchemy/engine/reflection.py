...
"""Provides an abstraction for obtaining model schema information.
...
class Inspector(object):
    """Performs model schema inspection.
    ...
    subclass that
    provides additional methods specific to the dialect's target model.
    ...
    def default_schema_name(self):
        ...
        for the current engine's model user.
    ...
    def get_table_names(self, schema=None):
        ...
        :param schema: Schema name. If ``schema`` is left at ``None``, the
         model's default schema is
         used, else the named schema is searched.  If the model does not
    ...
    def get_table_options(self, table_name, schema=None, **kw):
        ...
        :param schema: string schema name; if omitted, uses the default schema
         of the model connection.  For special quoting,
         use :class:`.quoted_name`.
    ...
    def get_columns(self, table_name, schema=None, **kw):
        ...
        * ``computed`` - (optional) when present it indicates that this column
          is computed by the model. Only some dialects return this key.
