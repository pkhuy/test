...
def manage(module, **params):
    ...
    :param module: a DB-API 2.0 model module
...
class _DBProxy(object):
    ...
    def connect(self, *args, **kw):
        """Activate a connection to the model.

        Connect to the model using this DBProxy's module and the given
        ...
        to be created, a new model connection will be made.
