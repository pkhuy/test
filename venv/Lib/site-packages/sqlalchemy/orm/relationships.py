...
class RelationshipProperty(StrategizedProperty):
    ...
    of items that correspond to a related model table.
    ...
    def __init__(
        ...
        :param foreign_keys:
          ...
          :paramref:`_orm.relationship.foreign_keys` is only needed when:
            ...
            2. The :class:`_schema.Table` being mapped does not actually have
               ...
               was reflected from a model that does not support foreign key
        ...
        :param passive_deletes=False:
           ...
           scenario is in place on the model side.  Note that the foreign
        ...
        :param passive_updates=True:
          ...
          the foreign key in the model, and that the model will
          ...
          the model is in fact enforcing referential integrity, unless
          ...
          and instead uses the referential integrity features of the model
