...
class StaleDataError(sa_exc.SQLAlchemyError):
    """An operation encountered model state that is unaccounted for.
    ...
    * A mapped object with version_id_col was refreshed,
      and the version number coming back from the model does
...
class ObjectDeletedError(sa_exc.InvalidRequestError):
    """A refresh operation failed to retrieve the model
