...
.. note::
   ...
   Will generate on the backing model as::
...
different than the actual name of the column as expressed in the model.
...
When using CONCURRENTLY, the PostgreSQL model requires that the statement
...
The PostgreSQL model creates a UNIQUE INDEX implicitly whenever the
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    def __init__(self, *enums, **kw):
        ...
        :param create_type: Defaults to True.
         ...
         without access to the actual model -
