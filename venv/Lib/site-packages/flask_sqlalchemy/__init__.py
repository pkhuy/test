...
def get_debug_queries():
    ...
    to the model.  This information is available until the end of request
...
class SQLAlchemy(object):
    ...
    def init_app(self, app):
        ...
        use with this model setup.  Never use a model in the context
    ...
    def apply_driver_hacks(self, app, sa_url, options):
        ...
        if sa_url.drivername.startswith('mysql'):
            ...
            if sa_url.database in (None, '', ':memory:'):
                ...
                if pool_size == 0:
                    raise RuntimeError('SQLite in memory model with an '
            ...
            # if it's not an in memory model we make the path absolute.
    ...
    @property
    def engine(self):
        """Gives access to the engine.  If the model configuration is bound
        to a specific application (initialized with an application) this will
        always return a model connection.  If however the current application
    ...
    def reflect(self, bind='__all__', app=None):
        """Reflects tables from the model.
